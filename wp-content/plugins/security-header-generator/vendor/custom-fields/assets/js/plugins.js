...
(function($) {
  ...
  function KPSHGAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  KPSHGAjaxChosen.prototype.init = function() {
  ...
  KPSHGAjaxChosen.prototype.events = function() {
  ...
  KPSHGAjaxChosen.prototype.search_field_focused = function() {
  ...
  KPSHGAjaxChosen.prototype.search_welcome_message = function() {
  ...
  KPSHGAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('kpshg-chosen', _this.options.data).done( function( response ) {
  ...
  KPSHGAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.kpshg-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.KPSHGChosenOrder($hidden_value, true);
  ...
  $.fn.KPSHGAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new KPSHGAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, KPSHGAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  KPSHGAbstractChosenOrder = (function() {

    function KPSHGAbstractChosenOrder() {}

    KPSHGAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    KPSHGAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    KPSHGAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    KPSHGAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    KPSHGAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    KPSHGAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    KPSHGAbstractChosenOrder.KPSHGChosenOrder = function(select, order, force) {
    ...
    return KPSHGAbstractChosenOrder;
  ...
  $.fn.extend({
    KPSHGChosenOrder: function(order, force) {
      return _KPSHGChosenOrder.KPSHGChosenOrder(this, order, force);
    }
  });

  this._KPSHGChosenOrder = (function(_super) {
    __extends(_KPSHGChosenOrder, _super);

    function _KPSHGChosenOrder() {
      _ref = _KPSHGChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _KPSHGChosenOrder.relAttributeName = 'data-option-array-index';

    _KPSHGChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _KPSHGChosenOrder.getDOMElement = function(element) {
    ...
    _KPSHGChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _KPSHGChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _KPSHGChosenOrder;

  })(KPSHGAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('kpshg-depend-on');
        });
...
(function(root, factory) {
  ...
  //
  // Kpshg: Added custom patterns for spesific validate
  //
  var patterns = {
  ...
  //
  // Kpshg: Renamed function names for avoid conflicts
  //

  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectKPSHG = FormSerializer.serializeObject;
    $.fn.serializeJSONKPSHG   = FormSerializer.serializeJSON;
  }
