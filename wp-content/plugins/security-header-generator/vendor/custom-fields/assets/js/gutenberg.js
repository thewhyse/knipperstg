 ...
 * -----------------------------------------------------------
 *
 * Kpshg Framework Gutenberg Block
...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.kpshg_gutenberg_blocks ) { return; }

  Object.values(window.kpshg_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'kpshg-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary kpshg-shortcode-button',
              onClick: function () {
                window.kpshg_gutenberg_props = props;
              },
            }, block.button_title ),
