 ...
 *
 */
if ( ! class_exists( 'KPSHG_Field_palette' ) ) {
  class KPSHG_Field_palette extends KPSHG_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $palette ) ) {
        ...
        echo '<div class="kpshg-siblings kpshg--palettes">';

        foreach ( $palette as $key => $colors ) {

          $active  = ( $key === $this->value ) ? ' kpshg--active' : '';
          $checked = ( $key === $this->value ) ? ' checked' : '';

          echo '<div class="kpshg--sibling kpshg--palette'. esc_attr( $active ) .'">';
