 ...
 *
 */
if ( ! class_exists( 'KPSHG_Field_sorter' ) ) {
  class KPSHG_Field_sorter extends KPSHG_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        'disabled'       => true,
        'enabled_title'  => esc_html__( 'Enabled', 'kpshg' ),
        'disabled_title' => esc_html__( 'Disabled', 'kpshg' ),
      ) );
      ...
      echo '<div class="kpshg-sorter" data-depend-id="'. esc_attr( $this->field['id'] ) .'"></div>';

      echo ( $args['disabled'] ) ? '<div class="kpshg-modules">' : '';

      echo ( ! empty( $args['enabled_title'] ) ) ? '<div class="kpshg-sorter-title">'. esc_attr( $args['enabled_title'] ) .'</div>' : '';
      echo '<ul class="kpshg-enabled">';
      ...
      if ( $args['disabled'] ) {
        ...
        echo '<div class="kpshg-modules">';
        echo ( ! empty( $args['disabled_title'] ) ) ? '<div class="kpshg-sorter-title">'. esc_attr( $args['disabled_title'] ) .'</div>' : '';
        echo '<ul class="kpshg-disabled">';
