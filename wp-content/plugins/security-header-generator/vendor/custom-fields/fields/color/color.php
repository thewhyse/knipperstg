 ...
 *
 */
if ( ! class_exists( 'KPSHG_Field_color' ) ) {
  class KPSHG_Field_color extends KPSHG_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="kpshg-color"'. $default_attr . $this->field_attributes() .'/>';
