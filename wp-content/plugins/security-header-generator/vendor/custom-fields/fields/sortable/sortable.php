 ...
 *
 */
if ( ! class_exists( 'KPSHG_Field_sortable' ) ) {
  class KPSHG_Field_sortable extends KPSHG_Fields {
    ...
    public function render() {
      ...
      echo '<div class="kpshg-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="kpshg-sortable-item">';

          echo '<div class="kpshg-sortable-content">';
          ...
          KPSHG::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="kpshg-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
