 ...
 *
 */
if ( ! class_exists( 'KPSHG_Abstract' ) ) {

  #[AllowDynamicProperties] // allows deprecated dynamic properties
  abstract class KPSHG_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        KPSHG::$css = apply_filters( "kpshg_{$this->unique}_output_css", KPSHG::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'KPSHG_Field_' . $field_type;
