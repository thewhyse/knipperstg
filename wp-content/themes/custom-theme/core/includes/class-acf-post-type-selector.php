...
class acf_Post_Type_Selector extends acf_Field
{
	...
	*-------------------------------------------------------------------------------------*/
	...
	function __construct($parent)
	{
    	...
    	// set name / title
    	$this->name = 'post_type_selector_field'; // variable name (no spaces / special characters / etc)
	...
	*-------------------------------------------------------------------------------------*/
	...
	function create_field($field)
	{
		...
		foreach (get_post_types() as $pt) :
			if ($pt == 'acf' || $pt == 'revision' || $pt == 'attachment' || $pt == 'nav_menu_item')
				continue;
			$pt_obj = get_post_type_object($pt);
			echo '<option value="' . $pt . '"' . ($pt == $field['value'] ? ' selected' : '') . '>' . $pt_obj->labels->name . '</option>';
		endforeach;
